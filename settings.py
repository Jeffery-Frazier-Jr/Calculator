...
OPERATORS = {
    'clear': {'col': 0, 'row': 2, 'text':'AC', 'operator':'/', 'image path': None},
    'invert': {'col': 1, 'row': 2, 'text':'/', 'operator':'/', 'image path': None},
    'clear': {'col': 2, 'row': 2, 'text':'/', 'operator':'/', 'image path': None},
}
